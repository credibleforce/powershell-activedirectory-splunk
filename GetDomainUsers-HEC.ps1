...
$props = "name","sAMAccountName","description","objectCategory","objectClass","objectSID","distinguishedName","mail","title","manager","info","physicalDeliveryOfficeName","department","company","lastLogonTimestamp","memberOf","accountexpires","whencreated","whenchanged","pwdLastSet","userAccountControl","primaryGroupId","userworkstations","usercertificate"
...
$logStarted = $false
$logFile = "$PSScriptRoot\getdomainusers_output.txt"

# required for hec_logging
$token = "HEC_TOKEN"
$server = "SERVER_IP"
$port = 8088
$sourcetype = "hec:ad_users"
...
function GetDomainUsers ($domainObj)
{
